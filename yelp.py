...
data = json.dumps(response, sort_keys=True, indent=2)
...
fcont = ""
if total > 0:
    #fname = "/data/yelp/json/"+options.term[1:]+".total"
    fname = "/data/yelp/json/"+options.term[1:]+"_over1000.total"
    fcont = options.bounds+"\t"+str(total)+"\n"
    
elif error != '':
    #fname = "/data/yelp/json/"+options.term[1:]+".error"
    fname = "/data/yelp/json/"+options.term[1:]+"_over1000.error"
    fcont = options.bounds+"\t"+str(error)+"\n"    
